...
class Profile extends Component {
  ...
  componentDidMount() {
    if (localStorage.getItem("familytreeuser")) {
      const obj = JSON.parse(localStorage.getItem("familytreeuser"));
      this.setState({ name: obj.name, email: obj.email, idx: obj.uid });
    }
  }
      ...
      <React.Fragment>
        <div className="page-content">
          <Container fluid>
            ...
            {/* Render Breadcrumb */}
            <Breadcrumb title="Family Tree" breadcrumbItem="Profile" />
              ...
              <CardBody>
                <AvForm className="form-horizontal" onValidSubmit={(e, v) => { this.handleValidSubmit(e, v) }}>
                  <div className="form-group">
                    <AvField name="name" label="UserName" value={this.state.name} className="form-control" placeholder="Enter UserName" type="text" required />
